...
## 최신 상태 · TP0913D001 / 후보 148

- 금요일 원본 재조회 수정(f5d99c2)과 백업 Date JSON 왕복 동등성 수정을 1.0(148)에 통합한다. 실제 충돌 차단은 유지하며 충돌 진단은 기록 타입만 남긴다. 사용자 원본/백업·키/PIN은 변경하지 않았다.
...
- 최신 테스트·배포 결과는 test.md의 TP0913D001과 build/validation/TP0913D001을 우선한다. 현재 148 최종 검증/배포를 진행 중이며, 이전 147 기록을 148 설치·기기 복구 증거로 쓰지 않는다.
